...
*   [🔍 toprank SEO & Ads Agent](https://github.com/nowork-studio/toprank) — Open-source Claude Code plugin providing SEO and Google Ads skills: meta tags, schema markup, keyword bids, and CMS content pushes.
